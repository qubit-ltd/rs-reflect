...
- **REQ-GEN-012**: Lifetime-parameterized derived types implement `Reflect` only for `Self: 'static`; full generic declarations remain navigable from valid instances, with no fake non-static `TypeId` or duplicate public descriptor trait.
