...
本矩阵逐项对应最终需求规范中的全部 284 个唯一 `REQ-*` ID。每行均给出实施任务、至少一个真实实现文件和至少一个真实测试文件；所有路径均已按仓库当前文件核验。
...
| REQ-ACCPT-003 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `src/access/field_adapter.rs`、`src/descriptor/field_descriptor.rs` | `tests/access/field_tests.rs`、`tests/ui/fail/thread_safe_field.rs` |
...
| REQ-ACCPT-005 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `src/private/registration.rs`、`src/registry/builder.rs` | `tests/registry/cross_crate_tests.rs` |
...
| REQ-ACCPT-007 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `src/value/mode.rs`、`src/value/dynamic_ref.rs`、`src/value/dynamic_mut.rs` | `tests/ui/fail/thread_safe_borrow_bound.rs`、`tests/ui/fail/thread_safe_field.rs` |
...
| REQ-ACCPT-017 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `src/value/mode.rs`、`src/value/dynamic_owned.rs` | `tests/value/thread_mode_tests.rs`、`tests/ui/fail/thread_safe_field.rs` |
...
| REQ-ACCPT-029 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `src/registry/builder.rs`、`src/private/registration.rs` | `tests/registry/cross_crate_tests.rs`、`tests/registry/runtime_tests.rs` |
...
| REQ-ACCPT-031 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `src/invoke/adapter.rs`、`derive/src/expand/impls.rs` | `tests/invocation_macro_contract_tests.rs`、`tests/panic_abort_invocation_tests.rs` |
...
| REQ-ACCPT-034 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `src/invoke/invocation.rs`、`src/invoke/recovery.rs` | `tests/invoke/runtime_tests.rs`、`tests/ui/fail/thread_safe_borrow_bound.rs` |
...
| REQ-ACCPT-036 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `src/registry/builder.rs`、`derive/src/expand/impls.rs` | `tests/registry/runtime_tests.rs`、`tests/generic_impl_trait_link_tests.rs` |
...
| REQ-ACCPT-044 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `derive/src/expand/structs.rs`、`src/descriptor/type_ref.rs` | `tests/ui/pass/opaque_generic.rs`、`tests/descriptor/generic_tests.rs` |
| REQ-ACCPT-045 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `src/invoke/adapter.rs`、`derive/src/expand/impls.rs` | `tests/invocation_macro_contract_tests.rs`、`tests/ui/pass/catch_unwind_thread_safe.rs` |
| REQ-ACCPT-046 | T14、T15、T17、T18、T19、T21、T22、T24、T25、T26 | `derive/src/expand/generics.rs`、`derive/src/expand/structs.rs` | `tests/ui/pass/lifetime_generic.rs`、`tests/descriptor/generic_tests.rs` |
...
| REQ-AGG-001 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-002 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-003 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-004 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-005 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-006 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-007 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-008 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-009 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-010 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-011 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-012 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-013 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-014 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
| REQ-AGG-015 | T12、T17、T20、T21、T26 | `src/registry/builder.rs`、`src/registry/fragment.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/cross_crate_tests.rs` |
...
| REQ-DESC-008 | T02、T11、T12 | `src/identity/fragment_id.rs`、`src/private/registration.rs`、`src/registry/builder.rs` | `tests/registry/runtime_tests.rs`、`tests/registry/stress_tests.rs` |
...
| REQ-ERR-001 | T02、T08、T09、T10、T12、T18、T19、T22 | `src/error/registry_error.rs`、`src/invoke/error.rs` | `tests/registry/runtime_tests.rs`、`tests/invoke/runtime_tests.rs` |
| REQ-ERR-002 | T02、T08、T09、T10、T12、T18、T19、T22 | `src/error/registry_error.rs`、`src/invoke/error.rs` | `tests/registry/runtime_tests.rs`、`tests/invoke/runtime_tests.rs` |
| REQ-ERR-003 | T02、T08、T09、T10、T12、T18、T19、T22 | `src/error/registry_error.rs`、`src/invoke/error.rs` | `tests/registry/runtime_tests.rs`、`tests/invoke/runtime_tests.rs` |
...
| REQ-INV-008 | T09、T17、T18、T22 | `src/invoke/future.rs`、`src/invoke/output.rs`、`derive/src/expand/impls.rs`、`derive/src/expand/traits.rs` | `tests/invocation_macro_contract_tests.rs`、`tests/invoke/runtime_tests.rs`、`tests/ui/pass/local_non_send_async.rs`、`tests/ui/fail/thread_safe_future_not_send.rs` |
| REQ-INV-009 | T09、T17、T18、T20、T22 | `derive/src/expand/generics.rs`、`derive/src/expand/impls.rs`、`src/descriptor/generic_descriptor.rs`、`src/descriptor/method_descriptor.rs` | `tests/descriptor/reflect_impl_tests.rs`、`tests/ui/pass/generic_impl_specialization.rs`、`tests/ui/fail/generic_impl_unsatisfied_specialization.rs` |
...
| REQ-INV-016 | T09、T17、T18、T22 | `src/invoke/future.rs`、`src/descriptor/method_descriptor.rs`、`derive/src/expand/impls.rs`、`derive/src/expand/traits.rs` | `tests/invocation_macro_contract_tests.rs`、`tests/descriptor/default_trait_invocation_tests.rs`、`tests/ui/pass/thread_safe_adapter.rs`、`tests/ui/fail/thread_safe_receiver_not_sync.rs`、`tests/ui/fail/thread_safe_owned_parameter_not_send_sync.rs`、`tests/ui/fail/thread_safe_owned_output_not_send_sync.rs`、`tests/ui/fail/thread_safe_future_not_send.rs` |
| REQ-MAC-001 | T13、T14、T15、T16、T17、T22 | `derive/src/lib.rs`、`derive/src/expand/structs.rs`、`derive/src/expand/enums.rs` | `tests/ui/pass/derive_struct.rs`、`tests/ui/pass/generic_enum.rs` |
...
| REQ-MAC-005 | T13、T14、T15、T16、T17、T22 | `derive/src/validate/declaration.rs` | `tests/ui/fail/derive_union.rs` |
...
| REQ-MAC-009 | T13、T14、T15、T16、T17、T22 | `derive/src/expand/traits.rs` | `tests/ui/pass/non_dyn_compatible_trait_declaration.rs`、`tests/descriptor/reflect_trait_tests.rs` |
...
| REQ-MAC-013 | T13、T14、T15、T16、T17、T22 | `derive/src/expand/impls.rs`、`src/registry/builder.rs` | `tests/registry/cross_crate_tests.rs` |
...
| REQ-MAC-018 | T13、T14、T15、T16、T17、T22 | `derive/src/parse/attributes.rs`、`derive/src/expand/impls.rs` | `tests/ui/fail/external_trait_id.rs`、`tests/descriptor/reflect_impl_tests.rs` |
...
| REQ-MAC-020 | T13、T14、T15、T16、T17、T20、T22 | `derive/src/expand/impls.rs`、`src/descriptor/impl_descriptor.rs` | `tests/ui/pass/generic_impl_specialization.rs`、`tests/descriptor/reflect_impl_tests.rs` |
| REQ-MAC-021 | T13、T14、T15、T16、T17、T22 | `derive/src/parse/attributes.rs`、`derive/src/expand/traits.rs` | `tests/descriptor/reflect_trait_tests.rs`、`tests/ui/fail/invalid_dyn_compatible_proof.rs` |
...
| REQ-OUT-002 | T01、T05、T06、T07、T12、T23、T26 | `src/private/registration.rs`、`src/registry/builder.rs` | `tests/registry/cross_crate_tests.rs` |
| REQ-OUT-003 | T01、T05、T06、T07、T12、T23、T26 | `src/value/storage.rs`、`src/access/field_adapter.rs` | `tests/ui/fail/thread_safe_borrow_bound.rs`、`tests/access/field_tests.rs` |
...
| REQ-TYPE-008 | T05、T11、T12、T13 | `src/descriptor/impl_descriptor.rs`、`src/registry/effective_type_view.rs`、`derive/src/validate/declaration.rs` | `tests/descriptor/type_descriptor_tests.rs`、`tests/ui/fail/duplicate_rename.rs` |
...
| REQ-TYPE-010 | T06、T14、T15 | `src/builtin/mod.rs`、`derive/src/expand/generics.rs`、`derive/src/expand/structs.rs` | `tests/descriptor/builtin_tests.rs`、`tests/descriptor/generic_tests.rs`、`tests/ui/pass/opaque_generic.rs` |
...
| REQ-TYPE-019 | T07、T12 | `src/capability/set.rs`、`src/capability/registration.rs`、`src/registry/builder.rs` | `tests/descriptor/capability_tests.rs`、`tests/registry/runtime_tests.rs` |
...
| REQ-TYPE-022 | T04、T05、T06、T16 | `src/descriptor/type_descriptor.rs`、`src/builtin/slice.rs`、`src/builtin/trait_object.rs`、`src/value/dynamic_owned.rs` | `tests/descriptor/builtin_tests.rs`、`tests/ui/fail/slice_dynamic_value.rs`、`tests/ui/fail/dyn_trait_dynamic_value.rs` |
...
| REQ-TYPE-025 | T12、T13、T21 | `src/registry/indexes.rs`、`src/registry/registry.rs`、`derive/src/validate/declaration.rs` | `tests/registry/runtime_tests.rs`、`tests/ui/fail/duplicate_rename.rs` |
...
| REQ-TYPE-027 | T06、T12 | `src/registry/interner.rs`、`src/registry/registry.rs`、`src/registry/builder.rs` | `tests/builtin_registry_freeze_tests.rs`、`tests/descriptor/builtin_tests.rs` |
...
| REQ-TYPE-029 | T05、T07、T14、T15、T19 | `derive/src/expand/structs.rs`、`derive/src/expand/enums.rs`、`src/private/descriptor.rs` | `tests/descriptor/derive_struct_tests.rs`、`tests/ui/pass/opaque_generic.rs`、`tests/descriptor/capability_tests.rs` |
...
| REQ-VAL-005 | T04、T22 | `src/value/mode.rs`、`src/value/storage.rs` | `src/value/mode.rs`、`tests/value/thread_mode_tests.rs`、`tests/ui/fail/thread_safe_borrow_bound.rs` |
...
| REQ-VAL-013 | T04、T22 | `src/value/dynamic_ref.rs`、`src/value/dynamic_mut.rs` | `src/value/mode.rs`、`tests/ui/fail/thread_safe_borrow_bound.rs` |
