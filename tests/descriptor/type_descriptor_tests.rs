...
static NAMED_RECORD: TypeDescriptor =
    reflect::__private::codegen_v3::descriptor::struct_type::<NamedRecord>(
        "record",
        StructKind::Named,
        &[],
    );
...
static REFLECTED_MEMBER: TypeDescriptor =
    reflect::__private::codegen_v3::descriptor::struct_type::<ReflectedMember>(
        "reflected_member",
        StructKind::Unit,
        &[],
    );
...
static OPAQUE_CONTAINER: TypeDescriptor =
    reflect::__private::codegen_v3::descriptor::struct_type::<OpaqueContainer>(
        "opaque_container",
        StructKind::Named,
        &OPAQUE_FIELDS,
    );
...
static RECURSIVE_NODE: TypeDescriptor =
    reflect::__private::codegen_v3::descriptor::struct_type::<RecursiveNode>(
        "recursive_node",
        StructKind::Named,
        &RECURSIVE_FIELDS,
    );
