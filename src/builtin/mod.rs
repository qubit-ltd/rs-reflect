...
use crate::capability::{
    TypeCapabilities, clone_descriptor, default_descriptor, send_descriptor, sync_descriptor,
};
use crate::descriptor::{PrimitiveKind, Reflect, TextKind, TypeDescriptor};
...
static STRING_DESCRIPTOR: TypeDescriptor = crate::__private::descriptor::text_with_capabilities::<
    String,
>("String", TextKind::String, string_capabilities);
