...
impl<'registry> IntoIterator for TypeDefinitionCandidates<'registry> {
    ...
    type IntoIter = std::iter::Copied<
        std::slice::Iter<'registry, &'static TypeDefinitionDescriptor>,
    >;
...
impl<'registry> TypeCandidates<'registry> {
    ...
    pub fn iter(
        self,
    ) -> impl ExactSizeIterator<Item = &'static TypeDescriptor> + 'registry
    {
        self.descriptors.iter().copied()
    }
...
impl<'registry> IntoIterator for TypeCandidates<'registry> {
    ...
    type IntoIter =
        std::iter::Copied<std::slice::Iter<'registry, &'static TypeDescriptor>>;
...
impl ImplDefinitionCandidates {
    ...
    pub fn iter(
        &self,
    ) -> impl ExactSizeIterator<Item = &'static ImplDefinitionDescriptor> + '_
    {
        self.descriptors.iter().copied()
    }
...
impl ReflectRegistry {
    ...
    pub fn initialize() -> Result<&'static Self, RegistryError> {
        static REGISTRY: OnceLock<Result<ReflectRegistry, RegistryError>> =
            OnceLock::new();
    ...
    pub fn find_definitions_by_query_name(
        &self,
        name: &str,
    ) -> TypeDefinitionCandidates<'_> {
        TypeDefinitionCandidates::new(
    ...
    pub fn definitions_with_identity(
        ...
        Item = (&'static TypeDefinitionDescriptor, &FragmentIdentity),
    > + '_ {
    ...
    pub fn types_with_identity(
        ...
        Item = (&'static TypeDescriptor, &FragmentIdentity),
    > + '_ {
    ...
    pub fn capabilities<'registry>(
        ...
        if let Some(capabilities) =
            self.indexes.capabilities_by_target.get(&type_id)
        {
    ...
    #[must_use]
    pub fn definition_capabilities(
        &self,
        id: TypeDefinitionId,
    ) -> &TypeCapabilities {
        self.indexes
    ...
    pub fn definitions_with_capability<A: 'static>(
        ...
        self.definitions.iter().copied().filter(move |definition| {
            self.definition_capabilities(definition.id()).contains(key)
        })
    }
